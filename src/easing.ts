...
export function linearEasing(points: readonly number[]): EasingFunction {
  if (points.length < 2) {
...
export const DEFAULT_LINEAR_POINTS: readonly number[] = [
...
export const DEFAULT_TRANSFORM_TIMING: ResolvedTiming = {
  duration: 900,
  easing: linearEasing(DEFAULT_LINEAR_POINTS),
};

export const DEFAULT_OPACITY_TIMING: ResolvedTiming = {
  duration: 450,

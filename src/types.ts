...
export type DigitInfo = { pos: number; length: number };

export type PluginUpdateContext = { trend: number };
export type PluginDeltaContext<S> = { trend: number; state: S };
